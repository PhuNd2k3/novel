...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getTranslators = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, index_db_1.query)("SELECT DISTINCT user_id, mail, username, phone_number address \n            FROM users JOIN novel ON users.user_id = novel.trans_id")];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
    ...
    UserService.prototype.loginAccount = function (account) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var mail, password, result, isMatch, access_token, refresh_token, err_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 3, , 4]);
                        mail = account.mail, password = account.password;
                        return [4 /*yield*/, (0, index_db_1.query)("SELECT * FROM users WHERE mail = $1", [mail])];
                    case 1:
                        result = _d.sent();
                    ...
                    case 2:
                        ...
                        access_token = (0, create_token_util_1.createToken)({
                            user_id: (_b = result.rows[0]) === null || _b === void 0 ? void 0 : _b.user_id,
                        ...
                        refresh_token = (0, create_token_util_1.createToken)({
                            user_id: (_c = result.rows[0]) === null || _c === void 0 ? void 0 : _c.user_id,
    ...
    UserService.prototype.registerAccount = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            var mail, password, phone_number, birth_year, username, address, results, hashPassword;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mail = account.mail, password = account.password, phone_number = account.phone_number, birth_year = account.birth_year, username = account.username, address = account.address;
                        return [4 /*yield*/, (0, index_db_1.query)("SELECT * FROM users WHERE mail = $1", [
                                mail,
                            ])];
                    case 1:
                        results = _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, index_db_1.query)("INSERT INTO users( mail, username, password, phone_number, birth_year, address) VALUES ($1, $2, $3, $4, $5, $6)", [mail, username, hashPassword, phone_number, birth_year, address])];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, {
                                statusCode: 201,
    ...
    UserService.prototype.getProfile = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, index_db_1.query)("SELECT user_id, mail, username, address, phone_number, birth_year FROM users WHERE user_id = $1", [user_id])];
                    case 1:
                        results = _a.sent();
                        if (!results.rows.length) {
                            return [2 /*return*/, {
